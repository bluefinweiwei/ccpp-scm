...
#WL
#parser.add_argument('-in', '--input', help='path to INPUT and FIX files', required=True)
###############################################################################
# Main program
###############################################################################
def main():
    ...
    #WL change to read in Shan's testing
    args.dir_ic      = args.dir + "/INPUT/"
    args.dir_grid    = args.dir + "/INPUT/"
    #args.dir_ic      = "/home/Weiwei.Li/UFS_phy/SFS/Shan_data/C96_new/"#args.dir + "/INPUT/"
    #args.dir_grid    = "/home/Weiwei.Li/UFS_phy/SFS/Shan_data/C96_new/"#args.dir + "/INPUT/"
